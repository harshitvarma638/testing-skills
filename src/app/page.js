    ...
    <main>
      <div>
        ...
        <div className='animation'>
            {notification ? (
              <Lottie options={defaultOptions} height={329} width={329} />
            ) : (
              <div className="rings">
                <svg width="329" height="329" viewBox="0 0 375 412" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {!notification && (
              <div className="bell">
                <svg width="196" height="196" viewBox="0 0 197 205" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="notification">
          ...
          <NotificationButton onNotificationSent={handleNotification}/>
        </div>
      </div>
    </main>
  );
